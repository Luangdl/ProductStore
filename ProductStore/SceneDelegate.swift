...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func buidTabBarController() -> UITabBarController {
        ...
        let vc1 = UINavigationController(rootViewController: ListingProductViewController())
        let vc2 = SecondViewController()
        let vc3 = UINavigationController(rootViewController: OrderListViewController())
